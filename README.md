...
This is a fork of [Tap-O-Matic DDV]([https://github.com/cormallen/tap-o-matic](https://github.com/abluenautilus/Tap-O-Matic-DDV)). I appreciate all of the work that's been put into this mnodule and the OG Time machine. Thanks to OAM for making it open source to begin with. The entire Tap-O-Matic DDV readme is quoted further down.
